...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/vibhuk10/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        8m40.561s          |         1:09.13           | 
| `pg_normalized_batch`  |        1m51.597s          |         0:14.07           | 
| `pg_denormalized`      |        0m19.276s          |         0:04.33           | 
